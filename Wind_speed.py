...
def addWind_speed_to_data(buffer = 0, dataFile = 'str') -> None:
...
addWind_speed_to_data(1, 'buffer_1_data.csv')
addWind_speed_to_data(2, 'buffer_2_data.csv')
addWind_speed_to_data(3, 'buffer_3_data.csv')